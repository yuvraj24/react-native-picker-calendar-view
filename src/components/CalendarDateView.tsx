...
import {
    Dimensions,
    FlatList, Image, StyleSheet, TouchableOpacity,
    View
} from 'react-native';
import TextView from '../../src/components/TextView';
import LeftArrowIcon from '../assets/images/back.png';
import RightArrowIcon from '../assets/images/next.png';
import type { CalendarDayProps, DayProps, MonthDateInfoProps } from '../interface/PropsInterface';
            ...
            <View style={[baseStyles.row, styles.flexStyle]}>
                ...
                <View style={styles.monthYearStyle}>
                    ...
                    >
                        ...
                        <Image source={LeftArrowIcon} style={[styles.arrowStyle, styles.dropArrowStyle]} />
                    </TouchableOpacity>
                    <TouchableOpacity
                        style={styles.monthYearStyle}
            ...
            renderItem={({ item, index }: { item: DayProps, index: number }) => {
                return (
                    <View style={[styles.viewDate, isShowGrid && styles.viewDateAllowed]}>
                        {RenderDay ?
                            <RenderDay
                                day={item} index={index}
                                month={month} year={year}
                                onDayPress={() => onDayPress && onDayPress({ day: item.value, month, year })}
                            />
                            : <DateItem
                                day={item} index={index}
                                month={month} year={year}
